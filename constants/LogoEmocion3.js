    ...
    return (
      <Svg width="24px" height="24px" viewBox="0 0 24 24">
        <G stroke="none" strokeWidth="2" fill="none" fill-rule="evenodd">
          ...
          />
          <Path
            d="M10,16.0285932 C10.4417123,16.4689387 11.108379,16.6891115 12,16.6891115 C12.891621,16.6891115 13.5582877,16.4689387 14,16.0285932"
            id="Path-23"
            stroke="#494C6B"
            strokeWidth="1.5"
            stroke-linecap="round"
            stroke-linejoin="round"
            transform="translate(12.000000, 16.358852) scale(1, -1) translate(-12.000000, -16.358852) "
          />
          <Path
