    ...
    this.serverData = [
      {
        ...
        {tipo: 'V', texto: 'Finalicé: ¿Qué es ser feliz?', bg: '#fdd58d'},
        {tipo: 'D', preguntas:[
          {pregunta: 'Lo que más aprecio en mi vida es:', respuesta: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua'},
          {pregunta: 'Mi actitud frente al cambio es:', respuesta: 'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur'},
          {pregunta: 'Las dificultades en la vida sirven para:', respuesta: 'Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum'},
        ]},
        {tipo: 'M', texto: 'Meditación: Ansiedad y estrés', bg: '#d9def8'},
        {tipo: 'A', texto: 'Inicio: Aprendiendo a Meditar', bg: '#50628f'},
      ],
      ...
      {fecha: '2019-12-12', eventos: [{tipo: 'A', texto: 'La Aventura Espiritual', bg: '#82d3eb'},]},
      {fecha: '2019-12-17', eventos: [
          {tipo: 'M', texto: 'Meditación: Meditación avanzada'},
          {tipo: 'D', preguntas:[
          {pregunta: 'Lo que más aprecio en mi vida es:', texto: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua'},
          {respuesta: 'Mi actitud frente al cambio es:', texto: 'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur'},
          {respuesta: 'Las dificultades en la vida sirven para:', texto: 'Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum'},
        ]},]},
      {fecha: '2019-12-18', eventos: [{tipo: 'V', texto: 'Finalicé: ¿Qué es ser feliz?', bg: '#fdd58d'}]},
      {fecha: '2019-12-19', eventos: [{tipo: 'A', texto: 'La Aventura Espiritual', bg: '#82d3eb'}]},
